        ...
        <div class="main-timeline">
                                ...
                                <div class="timeline">
                                    ...
                                    <div class="date-content">
                                        <div class="date-outer">
                                            <span class="date">
                                                    <span class="month">시작은? </span>
                                            <span class="year">여기서</span>
                                            </span>
                                        </div>
                                    </div>
                                    <div class="timeline-content">
                                        <h5 class="title">홍대 인기 &amp; 밥집</h5>
                                        <p class="description">
                                            여기다가 밥집을 띄우면 될거같음 
                                        </p>
                                    </div>
                                ...
                                <div class="timeline">
                                    ...
                                    <div class="date-content">
                                        <div class="date-outer">
                                            <span class="date">
                                                    <span class="month">배고픈데..</span>
                                            <span class="year">뭐 먹지?</span>
                                            </span>
                                        </div>
                                    </div>
                                    <div class="timeline-content">
                                        <h5 class="title">제목2</h5>
                                        <p class="description">
                                ...
                                <div class="timeline">
                                    ...
                                    <div class="date-content">
                                        <div class="date-outer">
                                            <span class="date">
                                                    <span class="month">그래도 </span>
                                            <span class="year">아쉬워?</span>
                                            </span>
                                        </div>
                                    </div>
                                    <div class="timeline-content">
                                        <h5 class="title">제목3</h5>
                                        <p class="description">
                                            뭐든 ...ㅠ 
                                        </p>
                                    </div>
