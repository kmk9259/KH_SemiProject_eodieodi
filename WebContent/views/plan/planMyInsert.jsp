		        ...
		        <%for(Place p : list) {%>
		        	<div class="card-group card-deck" style="width: 300px; display: inline-block;" >
						...
						<div class="card">
							...
							<div class="card-body">
								<h4 class="card-title placeTitle" id="placeTitle"><%=p.getPlaceTitle()%></h4>
	...
	<script>
		...
		$(function(){
			$(".card-img-top").click(function(){
				...
				searchPlaces(pTitle);      //지도에서 serch해주는 함수
			});
		});
		...
		//내가 추가!  클릭한 값으로 키워드 검색요청
		function searchPlaces(placeTitle) {
			
		    var keyword = placeTitle;
