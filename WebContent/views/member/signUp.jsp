	                    ...
	                    <form method="post" id="form1">
	                        ...
	                        <div class="row setup-content" id="step-1">
	                            <div class="col-xs-12">
	                                <div class="col-md-12">
	                                    ...
	                                    <div class="container">
	                                        ...
	                                        <div class="checkbox_group">
	                                            <div class="form-group col-md-4 mycustom" style="width: 80%;">
	                                                  ...
	                                                  <hr/>
	                                             <input type="checkbox" name="all" id="all" style="margin-left: 17%; margin-right:2%; float: left;">
	                                                  <h5>[필수] 위 이용약관을 모두 읽었으며 약관에 모두 동의합니다.</h5>
	                                           <br>
	                                              </div>
	                                          </div>
	                                        </div>
	                                ...
	                                <br><br><br>
	                                    <div id="btnNext" onClick="checkcheck();" style="margin-left: 40%; margin-top:35%; width: 20%; z-index: 9; position: relative; background-color: #545554; height: 65px; border-radius: 5px;">
	                                    	<br>
		                     ...
		                     $("#btnNext").prop("disabled", false);   //비활성화
		                       ...
		                       setCheckbox(form1_data, false);  ////form1_data(c1,c2,c3)의 값을 모두 no checked로 바꿈
								...
								function checkcheck()  {
								  ...
								  if(!c1.checked || !c2.checked || !c3.checked || !all.checked){
									  confirm("모두 동의해주세요.");
								  		$('#all').focus();
								  		return false;
								  }else{
