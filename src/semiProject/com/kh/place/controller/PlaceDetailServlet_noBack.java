 ...
 */
@WebServlet("/detailNo.pl")  //더보기 버튼 -> detail.pl로 이동하도록!
public class PlaceDetailServlet_noBack extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public PlaceDetailServlet_noBack() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(p != null)
		{
			...
			request.getRequestDispatcher("views/place/placeDetailNo.jsp").forward(request, response);
		}
		else
		{
