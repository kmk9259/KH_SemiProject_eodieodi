...
public class PlaceAttachment {
	...
	public PlaceAttachment(int fileNo, int refBoardNo, String originName, String changeName, String filePath,
	...
	public String toString() {
		return "PlaceAttachment [fileNo=" + fileNo + ", refBoardNo=" + refBoardNo + ", originName=" + originName
